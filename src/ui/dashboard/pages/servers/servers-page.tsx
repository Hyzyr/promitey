...
import { ServerErrorForwarder } from '@/components/providers/server-error-forwarder';
...
export const ServersPage = async () => {
  ...
  let region = 'auto';
  let regionError: ForwardedServerError | undefined;
  ...
  try {
    ...
    regionError = serializeServerError(e, 'ServersPage.getRegion');
  }

  return (
    <>
      <ServerErrorForwarder error={regionError} />
